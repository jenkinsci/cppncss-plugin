            ...
            public CategoryDataset buildData() {
                return buildDataset(build, new DataCollector() {
                    ...
                    public long getCollectedNumber(AbstractBuildReport action) {
                        ...
                        if (functionCcnViolationThreshold != null) {
                            for (Statistic statistic : functionResults) {
                                if (statistic.getCcn() > functionCcnViolationThreshold)
            ...
            public CategoryDataset buildData() {
                return buildDataset(build, new DataCollector() {
                    ...
                    public long getCollectedNumber(AbstractBuildReport action) {
                        ...
                        if (functionNcssViolationThreshold != null) {
                            for (Statistic statistic : functionResults) {
                                if (statistic.getNcss() > functionNcssViolationThreshold)
